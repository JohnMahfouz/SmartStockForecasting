...
- **XGBoost:** Industry-grade prediction engine  
- **Features:** Inputs like date, Ramadan status, recent sales  
- **Forecasting:** Predicting future demand using learned patterns  
